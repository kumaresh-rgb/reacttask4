...
const BlogCard = ({ category, title, imageSrc }) => (
  <div className="p-4 md:w-1/3">
    <div className={`h-full rounded-xl shadow-cla-${category} bg-gradient-to-r from-${category}-50 to-${category}-50 overflow-hidden`}>
      <img className="lg:h-48 md:h-36 w-full object-cover object-center scale-110 transition-all duration-400 hover:scale-100" src={imageSrc} alt="blog" />
      <div className="p-6">
        ...
        <button className="bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg hover:scale-105 shadow-md">
  Learn more
</button>
