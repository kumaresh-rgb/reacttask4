          ...
          <div className="flex items-center mt-6 gap-x-3">
            <Link to="/">
              <button className="flex items-center justify-center w-full px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
                <AiOutlineArrowLeft className="w-5 h-5 rtl:rotate-180" />
                <span>Go back</span>
              </button>
            </Link>

            <Link to="/">
              <button className="w-full flex px-2 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
