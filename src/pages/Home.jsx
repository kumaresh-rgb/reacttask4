...
const Home = () => {
    const handleJoinUsClick = () => {
        toast.success('You have successfully joined us!', {
          position: 'top-right', // You can customize the position
          autoClose: 3000, // Time in milliseconds to auto-close the toast (3 seconds in this example)
        });
      };
  ...
  return (
    ...
    <div class="mx-auto mt-10 w-full max-w-sm rounded-md border bg-transparent focus-within:border-blue-400 focus-within:ring focus-within:ring-blue-300 focus-within:ring-opacity-40 dark:border-gray-700 dark:focus-within:border-blue-300">
        ...
        <button onClick={handleJoinUsClick} type="button" class="m-1 h-10 transform rounded-md bg-blue-500 px-4 py-2 text-white transition-colors duration-300 hover:bg-blue-400 focus:bg-blue-400 focus:outline-none">Join Us</button>
        <ToastContainer />
        </form>
    </div>
    </div>
    ...
    <div onClick={UnderDev} class="container mx-auto px-6 pt-28 ">
