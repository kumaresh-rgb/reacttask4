...
const Home = () => {
  return (
    <section className="pt-24 bg-gray-800">
      <div className="px-12 mx-auto max-w-7xl">
        <div className="w-full mx-auto text-center md:w-10/12">
          <h1 className="mb-8 text-4xl font-extrabold leading-none tracking-normal text-slate-300 md:text-6xl md:tracking-tight">
            <span>Start</span> <span className="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-green-400 to-purple-500 lg:inline">building a buzz</span> <span>around your product ?</span>
          </h1>
          ...
          <div className="mb-4 space-x-2 md:mb-8">
            ...
            <div className="relative overflow-hidden shadow-2xl">
              <div className="flex items-center flex-none px-4 bg-green-400 rounded-b-none h-11 rounded-xl">
                <div className="flex space-x-1.5">
                  {[...Array(3)].map((_, index) => (
                    <div key={index} className="w-3 h-3 border-2 border-white rounded-full"></div>
                  ))}
                </div>
              </div>
              <img src="https://cdn.devdojo.com/images/march2021/green-dashboard.jpg" alt="Dashboard" className='mb-10'/>
            </div>
          </div>
        </div>
      </div>
